    ...
    if (error is DioException) {
      switch (error.type) {
        case DioExceptionType.cancel:
          return Failure(
            errorMessage: ApiErrorMessages.cancel,
          );
        ...
        case DioExceptionType.sendTimeout:
          return Failure(
            errorMessage:  ApiErrorMessages.sendTimeout
          );

        case DioExceptionType.receiveTimeout:
          return Failure(
            errorMessage:  ApiErrorMessages.receiveTimeout
          );
        ...
        case DioExceptionType.unknown:
          return Failure(
            errorMessage: ApiErrorMessages.unknown,
          );
      }
    }
