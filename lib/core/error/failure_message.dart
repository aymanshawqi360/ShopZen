...
class StoargeFailureMessage {
  static const String storageReadFailure =
      'Failed to read from secure storage.';
  static const String storageWriteFailure =
      'Failed to write to secure storage.';
  static const String storageDeleteFailure =
      'Failed to delete from secure storage.';
  static const String storageDeleteAllFailure =
      'Failed to delete all from secure storage.';
  static const String storageReadAllFailure =
  ...
  static const String decryptedTokenIsEmpty = 'Decrypted token is empty';
}
