...
class RegisterUseCases {
  ...
  Future<Either<Failure,RegisterResponseEntity>> register({required RegisterRequestModel authRequestModel}) => authRepository.register(authRequestModel: authRequestModel );
}