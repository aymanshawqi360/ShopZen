...
abstract class AuthApiService {
  ...
  Future<ForgotPasswordResponseModel> forgotPassword({
    @Body() required ForgotPasswordRequestModel body,
  });

  @POST(Endpoints.otpVerification)
  Future<ForgotPasswordResponseModel> otpVerification({
    @Body() required ResendOtpRequestModel body,
  });

  @POST(Endpoints.resetPassword)
  Future<ForgotPasswordResponseModel> resetPassword({
    @Body() required ResetPasswordRequestMode body,
  });

  @POST(Endpoints.passwordUpdate)
  Future<ForgotPasswordResponseModel> passwordUpdate({
    @Body() required PasswordUpdateRequestModel body,
  });
}
